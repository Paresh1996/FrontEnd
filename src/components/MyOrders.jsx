    ...
    return (
        <div className="container-fluid text-white">
            <div className="row">
                ...
                <table className="table table-bordered table-sm " style={{backgroundColor:"#DAF7E2"}}>
                    <thead>
                        <tr>
                            <th>Id</th>
                            <th>Order Date</th>
                    ...
                    <tbody>
                        {orders.map(x=>(
                            <tr key={x.orderid}>
                                ...
                                <td><button onClick={e=>showDetails(x.orderid)} className="btn  btn-sm"style={{backgroundColor:"#6cba82"}}>Show Details</button></td>
                            </tr>
                        ))}
                    </tbody>
                </table>  
                        ...
                        <tbody>
                            {details.map(x => (
                                <tr>
                                    ...
                                    <td><img className="mr-2 float-left" src={"http://localhost:9090/"+x.product.photo} width="100" />
                                    {x.product.pname}<br/>
