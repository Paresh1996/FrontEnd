...
function EditProduct(){
    ...
    useEffect(()=>{        
        ...
        axios.get("http://localhost:9090/api/products/"+prodid)
        .then(resp=>{
        ...
        if(Object.keys(errors).length===0 && submitted){            
            console.log(product)
            axios.put("http://localhost:9090/api/products/"+prodid,product)
            .then(resp=>{
    ...
    return (
        <div className="container-fluid" style={{backgroundColor:"#DAF7E2"}}>
                    <div className="row">
                        <div className="col-sm-3">
                            <img width="300" src={"http://localhost:9090/api/products"+product.photo} />
                        </div>
                        <div className="col-sm-9">
                            ...
                            <button className="btn  float-right" style= {{backgroundColor:"#6cba82"}}>Update Product</button>
                            </form>
                        </div>
                    </div>
                </div>
