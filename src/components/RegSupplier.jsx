...
//                 swal.fire({
//                     icon: "error",
//                     title: "Oh no...registration faild..!!",
//                     text: "Server is down,registration faild..!",
//                   });
//             })            
//         }
//     },)
...
//             <div className="card shadow  mt-3 text-dark" style={{backgroundColor:"#DAF7E2"}}>
...
//                         </div>
//                     </div>
//                     <button className="btn float-right" style={{backgroundColor:"#6cba82"}}>Register Now</button>
//                     </form>
//                 </div>
//             </div>
//         </div>
